...
const ResultsContainer = ({ resultId }) => {
  ...
  return result ? (
    <div className={styles.quizResults}>
      <div className={styles.mainQuizContainer}>
        <div className={styles.quizContainer}>
          ...
          <Image
            src="/images/terry-fly.png"
            width={150}
            height={100}
            className={styles.bobAnimation}
          />
          <p>
            Based on your results, we recommend you{" "}
            <span className={styles.resultBold}>{result.actionName}</span>. Time
            to implement these activities into your daily schedule or retake the
            quiz to get better results.
          </p>
        </div>
    ...
    <div>
      Please go to home to complete the quiz.{" "}
      <Link href="/">
